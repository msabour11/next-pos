erpnext.PointOfSale.ItemCart = class {
  ...
  render_customer_fields() {
    ...
    function handle_customer_field_change() {
      const current_value = me.customer_info[this.df.fieldname];
        ...
        frappe.msgprint("helllsssssssssss")
  ...
  load_invoice() {
    ...
    if (frm.doc.docstatus === 1) {
      ...
      // this.$totals_section.find(".checkout-btn").css("display", "flex","background-color":"red");
      this.$totals_section.find(".checkout-btn").css({
        display: "flex",
        backgroundColor: "red", // Corrected property name
      });
      this.$totals_section.find(".edit-cart-btn").css("display", "none");
    }
...
//   				console.log("the customer is", cus);
